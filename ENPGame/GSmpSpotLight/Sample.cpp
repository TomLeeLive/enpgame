...
bool Sample::Init()
{
	...
	if (FAILED(m_HeightMap.CreateHeightMap(L"../../data/HEIGHT_CASTLE.bmp")))
	{
		return false;
	}
	TMapDesc MapDesc = { m_HeightMap.m_iNumRows,m_HeightMap.m_iNumCols,	1.0f,0.1f,L"../../data/castle.jpg",	L"Lighting.hlsl" };
...
TBASIS_RUN(L"TBasisSample SpotLight");
