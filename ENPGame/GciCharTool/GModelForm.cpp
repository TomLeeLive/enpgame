...
void GModelForm::UpdateTextOBBInfo(D3DXVECTOR3 vMin, D3DXVECTOR3 vMax) {
	/*
	// CString -> int convert
	CString strNum = _T("5");
...
BEGIN_MESSAGE_MAP(GModelForm, CFormView)
	ON_BN_CLICKED(IDC_BUTTON1, &GModelForm::OnBnClickedButton1)
END_MESSAGE_MAP()
...
void GModelForm::OnBnClickedButton1()
{
