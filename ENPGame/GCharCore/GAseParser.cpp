...
bool GAseParser::Load(const TCHAR* strFileName)
{
...
bool GAseParser::GetVertexFromIndexData(TCHAR* strToken, DWORD dwSearchIndex, VOID* pData, INT DataType)
{
	GetData(strToken);
...
bool GAseParser::GetData(TCHAR* pString, VOID* pData, INT DataType, bool bLoop)
{
...
bool GAseParser::GetData(VOID* pData, INT DataType)
{
	if (pData != NULL)
	{
		switch (DataType)
...
bool GAseParser::GetNormalListFromString(TCHAR* strFaceList, DWORD dwNumFace, TAseMesh*	pGeomObj, TCHAR* strToken)
{
...
void GAseParser::LoadTM(TAseMesh* pObject)
{
	// NodeTM	
...
void GAseParser::LoadVisAnimation(TAseMesh* pObject)
{
...
void GAseParser::LoadAnimation(TAseMesh* pObject)
{
...
void GAseParser::LoadMesh(TAseMesh* pObject)
{
...
bool GAseParser::LoadGeomObject()
{
	INT iObjectType = -1;
...
bool GAseParser::LoadHelperObject()
{
	INT iObjectType = -1;
	auto pAseObject = make_shared<TAseMesh>();
	m_pAseMesh.push_back(pAseObject);
