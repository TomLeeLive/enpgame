...
HRESULT GHero::CreateConstantBuffer()
{
...
void GHero::SetActionFrame(int iStart, int iEnd,	int iCharacterMatrixIndex,	int iModelMatrixIndex)
{
...
void GHero::SetBoneMatrices(vector<D3DXMATRIX>* pList)
{
