...
HRESULT GN2Skybox::LoadTextureArray(ID3D11Device* pd3dDevice, ID3D11DeviceContext*    pContext, TCHAR** szTextureNames, int iNumTextures,
...
bool GN2Skybox::Create(ID3D11Device* pDevice, TCHAR* pLoadShaderFile, TCHAR* pLoadTextureString)
{
...
HRESULT GN2Skybox::LoadTextures(ID3D11Device* pDevice, TCHAR* pLoadTextureString)
{
	HRESULT hr = S_OK;
...
HRESULT GN2Skybox::CreateTextureArray(ID3D11Device* pDevice, ID3D11DeviceContext*    pContext)
{
	HRESULT hr = S_OK;
...
bool GN2Skybox::Render(ID3D11DeviceContext*    pContext)
{
