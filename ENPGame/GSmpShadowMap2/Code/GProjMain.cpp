...
bool GProjMain::Init()
{
	...
	TMapDesc MapDesc = { 33, 33, 10.0f,10.0f,/* L"data_test/castle.jpg"*/ L"data_test/write.png", L"data/shader_shadow/CustomizeMap_shadow.hlsl" };
