...
// KEffectToolView.cpp : CKEffectToolView 클래스의 구현
//
...
CKEffectToolDoc* CKEffectToolView::GetDocument() const // 디버그되지 않은 버전은 인라인으로 지정됩니다.
{
