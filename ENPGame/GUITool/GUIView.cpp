...
IMPLEMENT_DYNAMIC(GUIView, CDialogEx)

GUIView::GUIView(CWnd* pParent /*=NULL*/)
...
void GUIView::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(GUIView, CDialogEx)
	ON_BN_CLICKED(IDC_BUTTON1, &GUIView::OnBnClickedButton1)
	ON_NOTIFY(TVN_SELCHANGED, IDC_TREE1, &GUIView::OnTvnSelchangedTree1)
END_MESSAGE_MAP()
...
void GUIView::OnBnClickedButton1()
{
	// 파일 선택 대화상자
...
void GUIView::OnTvnSelchangedTree1(NMHDR *pNMHDR, LRESULT *pResult)
{
