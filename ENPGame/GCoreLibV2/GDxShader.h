...
public:
	GDxShader(void);
	virtual ~GDxShader(void);
};

class TShaderMgr : public GSingleton < TShaderMgr >
{
private:
	friend class GSingleton<TShaderMgr>;
	ID3D11Device*			m_pd3dDevice;
public:
	typedef map <INT, GDxShader*>					TemplateMap;
