...
bool GDirectWrite::Set(HWND hWnd, int iWidth, int iHeight, IDXGISurface1*	pSurface)
{
	HRESULT hr;	
	if( !Init() )
	{
...
HRESULT GDirectWrite::CreateDeviceIndependentResources()
{
    HRESULT hr;
...
HRESULT GDirectWrite::SetFont(wchar_t *fontFamily)
{
    HRESULT hr;
...
HRESULT GDirectWrite::SetFontSize(float size)
{
    HRESULT hr;
    DWRITE_TEXT_RANGE textRange = {0, m_cTextLength};
...
HRESULT GDirectWrite::SetText(D2D1_POINT_2F size, wchar_t *text,D2D1::ColorF Color)
{
    HRESULT hr = S_OK;
...
HRESULT GDirectWrite::SetBold(bool bold)
{
    HRESULT hr;
    DWRITE_TEXT_RANGE textRange = {0, m_cTextLength};
...
HRESULT GDirectWrite::SetItalic(bool italic)
{
    HRESULT hr;
    DWRITE_TEXT_RANGE textRange = {0, m_cTextLength};
...
HRESULT GDirectWrite::SetUnderline(bool underline)
{
    HRESULT hr;
    DWRITE_TEXT_RANGE textRange = {0, m_cTextLength};
...
void GDirectWrite::DiscardDeviceIndependentResources()
{
...
HRESULT GDirectWrite::DrawText( RECT rc, TCHAR* pText,  D2D1::ColorF Color )
{
...
HRESULT GDirectWrite::DrawText(D2D1_POINT_2F pos, D2D1::ColorF Color)
{
...
HRESULT GDirectWrite::CreateDeviceResources( IDXGISurface1*	pSurface)
{
	HRESULT hr = S_OK;
...
void GDirectWrite::DiscardDeviceResources()
{
	SAFE_RELEASE(m_pRT);
	SAFE_RELEASE(m_pBlackBrush);
}

void GDirectWrite::OnResize(UINT width, UINT height, IDXGISurface1*	pSurface)
{	
	DiscardDeviceResources();
	CreateDeviceResources( pSurface );
