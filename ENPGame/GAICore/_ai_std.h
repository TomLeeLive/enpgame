...
#define G_DEFINE_ANI_ZOMB_IDL L"ZOMBIE_IDLE2"
#define G_DEFINE_ANI_ZOMB_FLW L"ZOMBIE_RUN"

#define G_DEFINE_MAX_AI_ZOMBIE  4
#define G_DEFINE_CHAR_Y_POS 36.2f;
#define G_DEFINE_AI_ALMOST_ZERO	0.2f
#define G_DEFINE_AI_MOVE_COOLTIME 3.0f
#define G_DEFINE_AI_IDLE_CHECK 500.0f
#define G_DEFINE_AI_FOLLOW_CHECK 200.0f
#define G_DEFINE_AI_ATTACK_CHECK 40.0f
