...
bool CMapToolApp::Init()
{
	...
	//TMapDesc MapDesc = { m_GCreateMapDlg.m_iTileWidth, m_GCreateMapDlg.m_iTileHeight, 1.0f, 0.1f,L"data/castle.jpg", L"data/shader/plane.hlsl" };
