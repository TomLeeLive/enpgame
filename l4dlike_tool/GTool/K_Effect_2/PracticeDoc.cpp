...
// PracticeDoc.cpp : CPracticeDoc 클래스의 구현
//
...
// 축소판 그림을 지원합니다.
void CPracticeDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CPracticeDoc::InitializeSearchContent()
{
...
void CPracticeDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
