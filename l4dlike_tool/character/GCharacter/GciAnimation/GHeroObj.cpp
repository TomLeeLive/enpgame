...
HRESULT GHeroObj::CreateConstantBuffer()
{
...
void GHeroObj::SetActionFrame(int iStart, int iEnd,	int iCharacterMatrixIndex,	int iModelMatrixIndex)
{
...
void GHeroObj::SetBoneMatrices(vector<D3DXMATRIX>* pList)
{
...
bool	GHeroObj::Set(GCharacter* pChar, GBoneObj* pBone, 
...
bool		GHeroObj::Render(ID3D11DeviceContext*    pContext)
{
	// 메쉬 랜더링
	for (int iObj = 0; iObj < m_pChar->m_pModelList.size(); iObj++)
	{
