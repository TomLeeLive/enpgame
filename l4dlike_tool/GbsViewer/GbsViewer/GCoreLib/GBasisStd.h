...
#ifndef UNICODE
#error "GBASIS는 유니코드로 컴파일 해야 합니다."
#endif
...
namespace GBASIS
{
	...
	extern GBASIS_INPUT_MAP g_InputData;
}

//////////////////////////////////////////////
// WinMain 매크로
//////////////////////////////////////////////
#define GBASIS_START int WINAPI wWinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow ){ GbsViewer gGameMain; /* g_pMain = &gGameMain;*/
#define GBASIS_WIN(x) if( !gGameMain.InitWindow( hInstance, nCmdShow,  L#x ) )	{	return 0;	}	ShowCursor ( TRUE );gGameMain.Run();	return 1; }
